...
public class DefaultFireworkService implements FireworkService {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultFireworkService.class);
    ...
    private InputStream getImageStream() {
        return DefaultFireworkService.class.getResourceAsStream("/firework/sap-hybris-platform.png");
    }
